...
export const routes: Routes = [
  ...
  { path: 'prestador/disponibilidad', loadComponent: () => import('./features/prestadores/pages/disponibilidad/disponibilidad.component').then(c => c.DisponibilidadComponent) },
  { path: 'prestador/turnos', loadComponent: () => import('./features/prestadores/pages/turnos-prestador/turnos-prestador.component').then(c => c.TurnosPrestadorComponent) },
